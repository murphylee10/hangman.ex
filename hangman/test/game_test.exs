defmodule GameTest do
  ...
  test "correct recording of letters used" do
    game = Game.new_game()
    { game, _tally } = Game.make_move(game, "x")
    { game, _tally } = Game.make_move(game, "y")
    { game, _tally } = Game.make_move(game, "x")
  ...
  test "can handle a losing game" do
    [
      ...
      ["o", :good_guess,    5, ["_", "e", "l", "l", "o"], ["a", "e", "l", "o", "x"]],
      ["y", :bad_guess,     4, ["_", "e", "l", "l", "o"], ["a", "e", "l", "o", "x", "y"]],
      ["z", :bad_guess,     3, ["_", "e", "l", "l", "o"], ["a", "e", "l", "o", "x", "y", "z"]],
      ["b", :bad_guess,     2, ["_", "e", "l", "l", "o"], ["a", "b", "e", "l", "o", "x", "y", "z"]],
      ["c", :bad_guess,     1, ["_", "e", "l", "l", "o"], ["a", "b", "c", "e", "l", "o", "x", "y", "z"]],
      ["d", :lost,    0, ["_", "e", "l", "l", "o"], ["a", "b", "c", "d", "e", "l", "o", "x", "y", "z"]],
    ]
    |> test_sequence_of_moves()
  end
